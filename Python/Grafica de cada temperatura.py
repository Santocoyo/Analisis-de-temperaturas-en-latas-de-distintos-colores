...
plt.plot(date_listBlanca2,dataBlanca2["temperatura_lata"], label="Lata blanca 2")
plt.plot(date_listBlanca2,signal.medfilt(dataBlanca2["temperatura_ambiente"],31), label="Ambiente 2")
#Lata Aluminio 3
...
plt.plot(date_list,data["temperatura"], label="Lata aluminio 3")
#Lata Negra 4
...
for i in range(0,len(data)):
    fecha_hora=data["fecha"][i]+" "+data["hora"][i]
    date_list.append(datetime.strptime(fecha_hora, "%d.%m.%Y %H:%M:%S"))
plt.plot(date_list,data["temperatura_lata"], label="Lata negra 4")
# Lata Blanca 5
...
for i in range(0,len(data)):
    fecha_hora=data["fecha"][i]+" "+data["hora"][i]
    date_list.append(datetime.strptime(fecha_hora, "%d-%m-%Y %H:%M:%S"))
plt.plot(date_list,data["temperatura_lata"], label="Lata blanca 5")
plt.plot(date_list,signal.medfilt(data["temperatura_ambiente"],595), label="Ambiente 5")
#Lata Azul 7
...
for i in range(0,len(data)):
    fecha_hora=data["fecha"][i]+" "+data["hora"][i]
    date_list.append(datetime.strptime(fecha_hora, "%d-%m-%Y %H:%M:%S"))
plt.plot(date_list,data["temperatura"], label="Lata azul 7")
#Lata Blanca 8
...
for i in range(0,len(data)):
    fecha_hora=data["fecha"][i]+" "+data["hora"][i]
    date_list.append(datetime.strptime(fecha_hora, "%d.%m.%Y %H:%M:%S"))
plt.plot(date_list,signal.medfilt(data["temperatura_lata"],295), label="Lata blanca 8")
plt.plot(date_list,signal.medfilt(data["temperatura_ambiente"],9), label="Ambiente 8")
#Lata Aluminio 9
...
for i in range(0,len(data)):
    fecha_hora=data["fecha"][i]+" "+data["hora"][i]
    date_list.append(datetime.strptime(fecha_hora, "%d.%m.%Y %H:%M:%S"))
plt.plot(date_list,signal.medfilt(data["temperatura_lata"],389), label="Lata aluminio 9")
